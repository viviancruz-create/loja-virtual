...
todosSecoes()
const todosSecoes = (objprodutos) => {
  section_cards.innerHTML = '';


    objprodutos.forEach((elem, i) => {
        const navSecoes = document.createElement('nav');
        navSecoes.setAttribute('class');
        ...
        navSecoes.appendChild(imgProduto);
        navSecoes.appendChild(h2Titulo);
        navSecoes.appendChild(h3Valor);
        navSecoes.appendChild(btnCard);
